...
11. **novel_write_file** - 覆盖写入文件（自动备份）
12. **novel_append_to_file** - 追加写入文件（自动备份）
13. **novel_update_section** - 按 Markdown 标记更新局部内容
14. **novel_list_backups** - 列出备份文件
